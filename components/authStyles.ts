...
export const inputCls =
  "w-full rounded-md border border-neutral-200 bg-card px-3.5 py-3 text-[16px] " +
  "text-neutral-900 placeholder:text-neutral-600 transition-colors " +
...
// Sentence case (no ALLCAPS), sized for easy reading by first-time volunteers.
...
export const errorBannerCls =
  "rounded-lg border border-failed-200 bg-failed-50 px-3.5 py-2.5 text-[16px] text-failed-800";
